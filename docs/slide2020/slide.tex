...
\begin{frame}{関連研究}
  ...
  \item Minimum union cycleを更新\cite{Lee2012,Singh2015}
  \item Hypergraph sketch\cite{Yoshida2014}を更新する\cite{Hayashi2015}，
  \item 近似法を応用\cite{Bergamini2015a,Bergamini2015b}
  ...
  \begin{tabular}{lll}
    ...
    \alert{本研究} & \alert{RamalingamとReps}\cite{Ramalingam1996} & \alert{削除} \\ \hline
  \end{tabular}
\end{frame}
